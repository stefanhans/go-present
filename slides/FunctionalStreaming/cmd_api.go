...
func main() {
	...
	NodesOfInt := make(map[string]*NodeOfInt)
	typesOfNodes := make(map[string]interface{})

	typesOfNodes["NodeOfInt"] = NodesOfInt

	NodesOfInt["node_1"] = node_1
	NodesOfInt["node_2"] = node_2
