...
func main() {
	...
	node_1.ProduceAtMs(200).Connect(node_out)	// 1, 2, 3, 4, ...
	node_2.ProduceAtMs(200).Connect(node_out)	// 10, 20, 30, 40, ...
	node_3.ProduceAtMs(200).Connect(node_out)	// 100, 200, 300, 400, ...
